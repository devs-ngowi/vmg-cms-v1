...
} from "./chunk-55VVOOL2.js";
import {
  clamp,
  dist_exports as dist_exports7
} from "./chunk-ONRVXWZF.js";
import {
  createCollection,
  createCollection2,
  dist_exports as dist_exports4,
  useDirection
} from "./chunk-J5ZPMZR4.js";
import {
  Combination_default,
  FocusScope,
  hideOthers,
...
} from "./chunk-3OZJD45B.js";
import {
  Root as Root4,
  VisuallyHidden,
  dist_exports as dist_exports6
} from "./chunk-BBAMS2VL.js";
import {
  Anchor,
  Arrow,
  Content as Content2,
...
import {
  ...
  useId
} from "./chunk-MJE7XQLV.js";
import {
  dist_exports
} from "./chunk-ACC2MY3A.js";
import {
  usePrevious
...
import {
  ...
  useEffectEvent
} from "./chunk-LDLXPKEB.js";
import {
  useIsHydrated
} from "./chunk-BAMWVYOG.js";
import "./chunk-P6GBTP6V.js";
import {
  useCallbackRef
...
function createSlot(ownerName) {
  ...
  const Slot25 = React3.forwardRef((props, forwardedRef) => {
  ...
  Slot25.displayName = `${ownerName}.Slot`;
  return Slot25;
}
...
function createSlottable(ownerName) {
  const Slottable25 = ({ children }) => {
    return (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children });
  };
  Slottable25.displayName = `${ownerName}.Slottable`;
  Slottable25.__radixId = SLOTTABLE_IDENTIFIER;
  return Slottable25;
}
...
var Primitive = NODES.reduce((primitive, node) => {
  const Slot25 = createSlot(`Primitive.${node}`);
  const Node = React4.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot25 : node;
...
function createSlot2(ownerName) {
  ...
  const Slot25 = React6.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
...
function createSlottable2(ownerName) {
  ...
  Slottable25.displayName = `${ownerName}.Slottable`;
  Slottable25.__radixId = SLOTTABLE_IDENTIFIER2;
  return Slottable25;
}
...
var Primitive2 = NODES2.reduce((primitive, node) => {
  const Slot25 = createSlot2(`Primitive.${node}`);
...
function createSlot3(ownerName) {
  ...
  const Slot25 = React11.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
...
function createSlottable3(ownerName) {
  ...
  Slottable25.displayName = `${ownerName}.Slottable`;
  Slottable25.__radixId = SLOTTABLE_IDENTIFIER3;
  return Slottable25;
}
      ...
      WarningProvider,
      {
        ...
        children: (0, import_jsx_runtime12.jsx)(AlertDialogContentProvider, { scope: __scopeAlertDialog, cancelRef, children: (0, import_jsx_runtime12.jsxs)(
          Content,
          {
            ...
            children: [
              (0, import_jsx_runtime12.jsx)(Slottable4, { children }),
...
function createSlot4(ownerName) {
  ...
  const Slot25 = React13.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
...
function createSlottable4(ownerName) {
  ...
  Slottable25.displayName = `${ownerName}.Slottable`;
  Slottable25.__radixId = SLOTTABLE_IDENTIFIER4;
  return Slottable25;
}
...
var Primitive3 = NODES3.reduce((primitive, node) => {
  const Slot25 = createSlot4(`Primitive.${node}`);
...
function createContextScope4(scopeName, createContextScopeDeps = []) {
  ...
  function createContext32(rootComponentName, defaultContext) {
    ...
    const Provider2 = (props) => {
      ...
      return (0, import_jsx_runtime16.jsx)(Context.Provider, { value, children });
    };
    Provider2.displayName = rootComponentName + "Provider";
    function useContext22(consumerName, scope) {
      const Context = scope?.[scopeName]?.[index] || BaseContext;
...
function createSlot5(ownerName) {
  ...
  const Slot25 = React17.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
...
function createSlottable5(ownerName) {
  ...
  Slottable25.displayName = `${ownerName}.Slottable`;
  Slottable25.__radixId = SLOTTABLE_IDENTIFIER5;
  return Slottable25;
}
...
var Primitive4 = NODES4.reduce((primitive, node) => {
  const Slot25 = createSlot5(`Primitive.${node}`);
...
var [createAvatarContext, createAvatarScope] = createContextScope4(AVATAR_NAME);
var [AvatarProvider, useAvatarContext] = createAvatarContext(AVATAR_NAME);
var Avatar = React19.forwardRef(
  (props, forwardedRef) => {
    const { __scopeAvatar, ...avatarProps } = props;
    const [imageLoadingStatus, setImageLoadingStatus] = React19.useState("idle");
    return (0, import_jsx_runtime19.jsx)(
      AvatarProvider,
      {
        ...
        children: (0, import_jsx_runtime19.jsx)(Primitive4.span, { ...avatarProps, ref: forwardedRef })
      }
    );
  }
);
...
var AvatarImage = React19.forwardRef(
  (props, forwardedRef) => {
    ...
    return imageLoadingStatus === "loaded" ? (0, import_jsx_runtime19.jsx)(Primitive4.img, { ...imageProps, ref: forwardedRef, src }) : null;
  }
);
AvatarImage.displayName = IMAGE_NAME;
var FALLBACK_NAME = "AvatarFallback";
var AvatarFallback = React19.forwardRef(
  (props, forwardedRef) => {
    const { __scopeAvatar, delayMs, ...fallbackProps } = props;
    const context = useAvatarContext(FALLBACK_NAME, __scopeAvatar);
    const [canRender, setCanRender] = React19.useState(delayMs === void 0);
    React19.useEffect(() => {
      if (delayMs !== void 0) {
    ...
    return canRender && context.imageLoadingStatus !== "loaded" ? (0, import_jsx_runtime19.jsx)(Primitive4.span, { ...fallbackProps, ref: forwardedRef }) : null;
  }
);
...
function useImageLoadingStatus(src, { referrerPolicy, crossOrigin }) {
  ...
  const [loadingStatus, setLoadingStatus] = React19.useState(
...
function createSlot6(ownerName) {
  ...
  const Slot25 = React21.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
...
function createSlottable6(ownerName) {
  ...
  Slottable25.displayName = `${ownerName}.Slottable`;
  Slottable25.__radixId = SLOTTABLE_IDENTIFIER6;
  return Slottable25;
}
...
var Primitive5 = NODES5.reduce((primitive, node) => {
  const Slot25 = createSlot6(`Primitive.${node}`);
...
var [createContextMenuContext, createContextMenuScope] = createContextScope5(CONTEXT_MENU_NAME, [
  createMenuScope
]);
...
var ContextMenuTrigger = React23.forwardRef(
  (props, forwardedRef) => {
    const { __scopeContextMenu, disabled = false, ...triggerProps } = props;
    const context = useContextMenuContext(TRIGGER_NAME4, __scopeContextMenu);
    const menuScope = useMenuScope(__scopeContextMenu);
    const pointRef = React23.useRef({ x: 0, y: 0 });
    const virtualRef = React23.useRef({
      getBoundingClientRect: () => DOMRect.fromRect({ width: 0, height: 0, ...pointRef.current })
    });
    const longPressTimerRef = React23.useRef(0);
    const clearLongPress = React23.useCallback(
    ...
    React23.useEffect(() => clearLongPress, [clearLongPress]);
    React23.useEffect(() => void (disabled && clearLongPress()), [disabled, clearLongPress]);
...
var ContextMenuContent = React23.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuGroup = React23.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuLabel = React23.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuItem = React23.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuCheckboxItem = React23.forwardRef((props, forwardedRef) => {
...
var ContextMenuRadioGroup = React23.forwardRef((props, forwardedRef) => {
...
var ContextMenuRadioItem = React23.forwardRef((props, forwardedRef) => {
...
var ContextMenuItemIndicator = React23.forwardRef((props, forwardedRef) => {
...
var ContextMenuSeparator = React23.forwardRef((props, forwardedRef) => {
...
var ContextMenuArrow = React23.forwardRef(
  (props, forwardedRef) => {
    const { __scopeContextMenu, ...arrowProps } = props;
    const menuScope = useMenuScope(__scopeContextMenu);
    return (0, import_jsx_runtime23.jsx)(Arrow2, { ...menuScope, ...arrowProps, ref: forwardedRef });
  }
);
...
var ContextMenuSubTrigger = React23.forwardRef((props, forwardedRef) => {
...
var ContextMenuSubContent = React23.forwardRef((props, forwardedRef) => {
...
function createSlot7(ownerName) {
  ...
  const Slot25 = React25.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
...
function createSlottable7(ownerName) {
  ...
  Slottable25.displayName = `${ownerName}.Slottable`;
  Slottable25.__radixId = SLOTTABLE_IDENTIFIER7;
  return Slottable25;
}
...
var Primitive6 = NODES6.reduce((primitive, node) => {
  const Slot25 = createSlot7(`Primitive.${node}`);
...
var [createFormContext, createFormScope] = createContextScope6("Form");
var FORM_NAME = "Form";
...
var FormField = React28.forwardRef(
  (props, forwardedRef) => {
    ...
    const id = useId();
    return (0, import_jsx_runtime28.jsx)(FormFieldProvider, { scope: __scopeForm, id, name, serverInvalid, children: (0, import_jsx_runtime28.jsx)(
      Primitive6.div,
      {
...
var FormMessage = React28.forwardRef(
  (props, forwardedRef) => {
    ...
    if (match === void 0) {
      return (0, import_jsx_runtime28.jsx)(FormMessageImpl, { ...messageProps, ref: forwardedRef, name, children: props.children || DEFAULT_INVALID_MESSAGE });
    } else if (typeof match === "function") {
      return (0, import_jsx_runtime28.jsx)(FormCustomMessage, { match, ...messageProps, ref: forwardedRef, name });
    } else {
      return (0, import_jsx_runtime28.jsx)(FormBuiltInMessage, { match, ...messageProps, ref: forwardedRef, name });
    }
  }
);
...
var FormBuiltInMessage = React28.forwardRef(
  (props, forwardedRef) => {
    ...
    if (matches) {
      return (0, import_jsx_runtime28.jsx)(FormMessageImpl, { ref: forwardedRef, ...messageProps, name, children: children ?? DEFAULT_BUILT_IN_MESSAGES[match] });
    }
    return null;
  }
);
var FormCustomMessage = React28.forwardRef(
  (props, forwardedRef) => {
    ...
    if (matches) {
      return (0, import_jsx_runtime28.jsx)(FormMessageImpl, { id, ref: composedRef, ...messageProps, name, children: children ?? DEFAULT_INVALID_MESSAGE });
    }
    return null;
  }
);
var FormMessageImpl = React28.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime28.jsx)(Primitive6.span, { id, ...messageProps, ref: forwardedRef });
  }
);
...
var FormValidityState = (props) => {
  ...
  const name = nameProp ?? fieldContext.name;
  const validity = validationContext.getFieldValidity(name);
  return (0, import_jsx_runtime28.jsx)(import_jsx_runtime28.Fragment, { children: children(validity) });
};
...
var FormSubmit = React28.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime28.jsx)(Primitive6.button, { type: "submit", ...submitProps, ref: forwardedRef });
  }
);
...
function createContextScope7(scopeName, createContextScopeDeps = []) {
  let defaultContexts = [];
  function createContext32(rootComponentName, defaultContext) {
    const BaseContext = React29.createContext(defaultContext);
    const index = defaultContexts.length;
    defaultContexts = [...defaultContexts, defaultContext];
    const Provider2 = (props) => {
      const { scope, children, ...context } = props;
      const Context = scope?.[scopeName]?.[index] || BaseContext;
      const value = React29.useMemo(() => context, Object.values(context));
      return (0, import_jsx_runtime29.jsx)(Context.Provider, { value, children });
    };
    Provider2.displayName = rootComponentName + "Provider";
    function useContext22(consumerName, scope) {
      const Context = scope?.[scopeName]?.[index] || BaseContext;
      const context = React29.useContext(Context);
      if (context) return context;
      if (defaultContext !== void 0) return defaultContext;
      throw new Error(`\`${consumerName}\` must be used within \`${rootComponentName}\``);
    }
  ...
  const createScope = () => {
    const scopeContexts = defaultContexts.map((defaultContext) => {
      return React29.createContext(defaultContext);
    });
    return function useScope(scope) {
      const contexts = scope?.[scopeName] || scopeContexts;
...
function composeContextScopes7(...scopes) {
  ...
  const createScope = () => {
    ...
    return function useComposedScopes(overrideScopes) {
      ...
      return React29.useMemo(() => ({ [`__scope${baseScope.scopeName}`]: nextScopes }), [nextScopes]);
    };
  };
  createScope.scopeName = baseScope.scopeName;
  return createScope;
...
function createSlot8(ownerName) {
  ...
  const Slot25 = React30.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
...
function createSlottable8(ownerName) {
  ...
  Slottable25.displayName = `${ownerName}.Slottable`;
  Slottable25.__radixId = SLOTTABLE_IDENTIFIER8;
  return Slottable25;
}
var Slottable9 = createSlottable8("Slottable");
function isSlottable8(child) {
  return React30.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER8;
}
...
var Primitive7 = NODES7.reduce((primitive, node) => {
  const Slot25 = createSlot8(`Primitive.${node}`);
  const Node = React31.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot25 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
...
var [createHoverCardContext, createHoverCardScope] = createContextScope7(HOVERCARD_NAME, [
  createPopperScope
]);
...
var HoverCard = (props) => {
  ...
  return (0, import_jsx_runtime32.jsx)(
    HoverCardProvider,
    {
      ...
      children: (0, import_jsx_runtime32.jsx)(Root22, { ...popperScope, children })
    }
  );
};
...
var HoverCardPortal = (props) => {
  ...
  return (0, import_jsx_runtime32.jsx)(PortalProvider, { scope: __scopeHoverCard, forceMount, children: (0, import_jsx_runtime32.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime32.jsx)(Portal, { asChild: true, container, children }) }) });
};
...
var HoverCardContent = React32.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime32.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime32.jsx)(
...
var HoverCardArrow = React32.forwardRef(
  (props, forwardedRef) => {
    ...
    const popperScope = usePopperScope(__scopeHoverCard);
    return (0, import_jsx_runtime32.jsx)(Arrow, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
...
var NAME4 = "Label";
var Label5 = React33.forwardRef((props, forwardedRef) => {
...
function createSlot9(ownerName) {
  ...
  const Slot25 = React35.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
...
function createSlottable9(ownerName) {
  ...
  Slottable25.displayName = `${ownerName}.Slottable`;
  Slottable25.__radixId = SLOTTABLE_IDENTIFIER9;
  return Slottable25;
}
var Slottable10 = createSlottable9("Slottable");
function isSlottable9(child) {
  return React35.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER9;
}
...
var Primitive8 = NODES8.reduce((primitive, node) => {
  const Slot25 = createSlot9(`Primitive.${node}`);
...
var [createMenubarContext, createMenubarScope] = createContextScope8(MENUBAR_NAME, [
...
var Menubar = React37.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeMenubar,
      value: valueProp,
    ...
    const [currentTabStopId, setCurrentTabStopId] = React37.useState(null);
    return (0, import_jsx_runtime37.jsx)(
      MenubarContextProvider,
      {
        scope: __scopeMenubar,
        value,
        onMenuOpen: React37.useCallback(
          (value2) => {
            setValue(value2);
        ...
        onMenuClose: React37.useCallback(() => setValue(""), [setValue]),
        onMenuToggle: React37.useCallback(
          (value2) => {
        ...
        dir: direction,
        loop,
        children: (0, import_jsx_runtime37.jsx)(Collection2.Provider, { scope: __scopeMenubar, children: (0, import_jsx_runtime37.jsx)(Collection2.Slot, { scope: __scopeMenubar, children: (0, import_jsx_runtime37.jsx)(
          Root3,
          {
            asChild: true,
            ...
            children: (0, import_jsx_runtime37.jsx)(Primitive8.div, { role: "menubar", ...menubarProps, ref: forwardedRef })
          }
        ) }) })
      }
    );
...
var MenubarMenu = (props) => {
  ...
  const wasKeyboardTriggerOpenRef = React37.useRef(false);
...
var MenubarTrigger = React37.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime37.jsx)(Collection2.ItemSlot, { scope: __scopeMenubar, value: menuContext.value, disabled, children: (0, import_jsx_runtime37.jsx)(
      Item,
      {
        asChild: true,
        ...rovingFocusGroupScope,
        ...
        children: (0, import_jsx_runtime37.jsx)(Anchor2, { asChild: true, ...menuScope, children: (0, import_jsx_runtime37.jsx)(
          Primitive8.button,
          {
            type: "button",
            role: "menuitem",
...
var MenubarGroup = React37.forwardRef(
  (props, forwardedRef) => {
...
var MenubarLabel = React37.forwardRef(
  (props, forwardedRef) => {
...
var MenubarItem = React37.forwardRef(
  (props, forwardedRef) => {
...
var MenubarCheckboxItem = React37.forwardRef(
  (props, forwardedRef) => {
...
var MenubarRadioGroup = React37.forwardRef(
  (props, forwardedRef) => {
...
var MenubarRadioItem = React37.forwardRef(
  (props, forwardedRef) => {
...
var MenubarItemIndicator = React37.forwardRef((props, forwardedRef) => {
...
var MenubarSeparator = React37.forwardRef(
  (props, forwardedRef) => {
...
var MenubarArrow = React37.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenubar, ...arrowProps } = props;
    const menuScope = useMenuScope2(__scopeMenubar);
    return (0, import_jsx_runtime37.jsx)(Arrow2, { ...menuScope, ...arrowProps, ref: forwardedRef });
  }
);
...
var MenubarSubTrigger = React37.forwardRef(
  (props, forwardedRef) => {
...
var MenubarSubContent = React37.forwardRef(
  (props, forwardedRef) => {
...
function createContextScope9(scopeName, createContextScopeDeps = []) {
  ...
  function createContext32(rootComponentName, defaultContext) {
    ...
    const Provider2 = (props) => {
      ...
      return (0, import_jsx_runtime38.jsx)(Context.Provider, { value, children });
    };
    Provider2.displayName = rootComponentName + "Provider";
    function useContext22(consumerName, scope) {
      const Context = scope?.[scopeName]?.[index] || BaseContext;
...
function createSlot10(ownerName) {
  ...
  const Slot25 = React39.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
...
function createSlottable10(ownerName) {
  ...
  Slottable25.displayName = `${ownerName}.Slottable`;
  Slottable25.__radixId = SLOTTABLE_IDENTIFIER10;
  return Slottable25;
}
var Slottable11 = createSlottable10("Slottable");
function isSlottable10(child) {
  return React39.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER10;
}
...
var Primitive9 = NODES9.reduce((primitive, node) => {
  const Slot25 = createSlot10(`Primitive.${node}`);
...
var [createNavigationMenuContext, createNavigationMenuScope] = createContextScope9(
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime41.jsx)(
      NavigationMenuProvider,
      {
        ...
        onItemDismiss: () => setValue(""),
        children: (0, import_jsx_runtime41.jsx)(Primitive9.div, { "data-orientation": orientation, ...subProps, ref: forwardedRef })
      }
    );
  }
);
...
var NavigationMenuProvider = (props) => {
  ...
  return (0, import_jsx_runtime41.jsx)(
    NavigationMenuProviderImpl,
    {
      ...
      children: (0, import_jsx_runtime41.jsx)(Collection3.Provider, { scope, children: (0, import_jsx_runtime41.jsx)(ViewportContentProvider, { scope, items: viewportContent, children }) })
    }
  );
};
...
var NavigationMenuList = React41.forwardRef(
  (props, forwardedRef) => {
    ...
    const list = (0, import_jsx_runtime41.jsx)(Primitive9.ul, { "data-orientation": context.orientation, ...listProps, ref: forwardedRef });
    return (0, import_jsx_runtime41.jsx)(Primitive9.div, { style: { position: "relative" }, ref: context.onIndicatorTrackChange, children: (0, import_jsx_runtime41.jsx)(Collection3.Slot, { scope: __scopeNavigationMenu, children: context.isRootMenu ? (0, import_jsx_runtime41.jsx)(FocusGroup, { asChild: true, children: list }) : list }) });
  }
);
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime41.jsx)(
      NavigationMenuItemContextProvider,
      {
        ...
        children: (0, import_jsx_runtime41.jsx)(Primitive9.li, { ...itemProps, ref: forwardedRef })
      }
    );
  }
);
...
var NavigationMenuTrigger = React41.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime41.jsxs)(import_jsx_runtime41.Fragment, { children: [
    (0, import_jsx_runtime41.jsx)(Collection3.ItemSlot, { scope: __scopeNavigationMenu, value: itemContext.value, children: (0, import_jsx_runtime41.jsx)(FocusGroupItem, { asChild: true, children: (0, import_jsx_runtime41.jsx)(
      Primitive9.button,
      {
        id: triggerId,
        disabled,
    ...
    open && (0, import_jsx_runtime41.jsxs)(import_jsx_runtime41.Fragment, { children: [
      ...
      context.viewport && (0, import_jsx_runtime41.jsx)("span", { "aria-owns": contentId })
    ] })
  ] });
});
...
var NavigationMenuLink = React41.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime41.jsx)(FocusGroupItem, { asChild: true, children: (0, import_jsx_runtime41.jsx)(
      Primitive9.a,
      {
...
var NavigationMenuIndicator = React41.forwardRef((props, forwardedRef) => {
  ...
  return context.indicatorTrack ? import_react_dom.default.createPortal(
    (0, import_jsx_runtime41.jsx)(Presence, { present: forceMount || isVisible, children: (0, import_jsx_runtime41.jsx)(NavigationMenuIndicatorImpl, { ...indicatorProps, ref: forwardedRef }) }),
...
var NavigationMenuIndicatorImpl = React41.forwardRef((props, forwardedRef) => {
  ...
  return position ? (0, import_jsx_runtime41.jsx)(
    Primitive9.div,
    {
      "aria-hidden": true,
...
var NavigationMenuContent = React41.forwardRef((props, forwardedRef) => {
  ...
  return !context.viewport ? (0, import_jsx_runtime41.jsx)(Presence, { present: forceMount || open, children: (0, import_jsx_runtime41.jsx)(
  ...
  ) }) : (0, import_jsx_runtime41.jsx)(ViewportContentMounter, { forceMount, ...commonProps, ref: composedRefs });
});
...
var NavigationMenuContentImpl = React41.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime41.jsx)(FocusGroup, { asChild: true, children: (0, import_jsx_runtime41.jsx)(
    DismissableLayer,
    {
      id: contentId,
...
var NavigationMenuViewport = React41.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime41.jsx)(Presence, { present: forceMount || open, children: (0, import_jsx_runtime41.jsx)(NavigationMenuViewportImpl, { ...viewportProps, ref: forwardedRef }) });
});
...
var NavigationMenuViewportImpl = React41.forwardRef((props, forwardedRef) => {
  ...
  const [size, setSize] = React41.useState(null);
  ...
  return (0, import_jsx_runtime41.jsx)(
    Primitive9.div,
    {
      ...
      children: Array.from(viewportContentContext.items).map(([value, { ref, forceMount, ...props2 }]) => {
        ...
        return (0, import_jsx_runtime41.jsx)(Presence, { present: forceMount || isActive, children: (0, import_jsx_runtime41.jsx)(
          NavigationMenuContentImpl,
          {
            ...props2,
...
var FocusGroup = React41.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime41.jsx)(FocusGroupCollection.Provider, { scope: __scopeNavigationMenu, children: (0, import_jsx_runtime41.jsx)(FocusGroupCollection.Slot, { scope: __scopeNavigationMenu, children: (0, import_jsx_runtime41.jsx)(Primitive9.div, { dir: context.dir, ...groupProps, ref: forwardedRef }) }) });
  }
);
...
var FocusGroupItem = React41.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime41.jsx)(FocusGroupCollection.ItemSlot, { scope: __scopeNavigationMenu, children: (0, import_jsx_runtime41.jsx)(
      Primitive9.button,
      {
        ...groupProps,
        ref: forwardedRef,
...
function createSlot11(ownerName) {
  ...
  const Slot25 = React42.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
...
function createSlottable11(ownerName) {
  ...
  Slottable25.displayName = `${ownerName}.Slottable`;
  Slottable25.__radixId = SLOTTABLE_IDENTIFIER11;
  return Slottable25;
}
...
var Primitive10 = NODES10.reduce((primitive, node) => {
  const Slot25 = createSlot11(`Primitive.${node}`);
...
function createContextScope10(scopeName, createContextScopeDeps = []) {
  ...
  function createContext32(rootComponentName, defaultContext) {
    ...
    const Provider2 = (props) => {
      ...
      return (0, import_jsx_runtime44.jsx)(Context.Provider, { value, children });
    };
    Provider2.displayName = rootComponentName + "Provider";
    function useContext22(consumerName, scope) {
      const Context = scope?.[scopeName]?.[index] || BaseContext;
...
var [createOneTimePasswordFieldContext] = createContextScope10(ONE_TIME_PASSWORD_FIELD_NAME, [
...
var OneTimePasswordField = React45.forwardRef(
  function OneTimePasswordFieldImpl({
    ...
    const sanitizeValue = React45.useCallback(
      (value2) => {
    ...
    const controlledValue = React45.useMemo(() => {
    ...
    const validationTypeRef = React45.useRef(validation);
    React45.useEffect(() => {
      if (!validation) {
        return;
      }
    ...
    const hiddenInputRef = React45.useRef(null);
    const userActionRef = React45.useRef(null);
    ...
    const locateForm = React45.useCallback(() => {
      let formElement;
      if (form) {
    ...
    const attemptSubmit = React45.useCallback(() => {
    ...
    const valueRef = React45.useRef(currentValue);
    ...
    return (0, import_jsx_runtime45.jsx)(
      OneTimePasswordFieldContext,
      {
        ...
        isHydrated,
        sanitizeValue,
        children: (0, import_jsx_runtime45.jsx)(Collection4.Provider, { scope: __scopeOneTimePasswordField, state: collectionState, children: (0, import_jsx_runtime45.jsx)(Collection4.Slot, { scope: __scopeOneTimePasswordField, children: (0, import_jsx_runtime45.jsx)(
          Root3,
          {
            asChild: true,
            ...rovingFocusGroupScope,
...
var OneTimePasswordFieldHiddenInput = React45.forwardRef(function OneTimePasswordFieldHiddenInput2({ __scopeOneTimePasswordField, ...props }, forwardedRef) {
...
var OneTimePasswordFieldInput = React45.forwardRef(function OneTimePasswordFieldInput2({
  __scopeOneTimePasswordField,
  onInvalidChange,
  index: indexProp,
  ...props
  ...
  const [element, setElement] = React45.useState(null);
  ...
  const keyboardActionTimeoutRef = React45.useRef(null);
  React45.useEffect(() => {
    return () => {
  ...
  return (0, import_jsx_runtime45.jsx)(Collection4.ItemSlot, { scope: __scopeOneTimePasswordField, children: (0, import_jsx_runtime45.jsx)(
    Item,
    {
      ...rovingFocusGroupScope,
      asChild: true,
...
function createSlot12(ownerName) {
  ...
  const Slot25 = React46.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime46.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React46.isValidElement(newElement) ? React46.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlottable12(ownerName) {
  ...
  Slottable25.displayName = `${ownerName}.Slottable`;
  Slottable25.__radixId = SLOTTABLE_IDENTIFIER12;
  return Slottable25;
}
var Slottable13 = createSlottable12("Slottable");
function isSlottable12(child) {
  return React46.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER12;
}
...
var Primitive11 = NODES11.reduce((primitive, node) => {
  const Slot25 = createSlot12(`Primitive.${node}`);
  const Node = React47.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot25 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
...
function createContextScope11(scopeName, createContextScopeDeps = []) {
  let defaultContexts = [];
  function createContext32(rootComponentName, defaultContext) {
    const BaseContext = React48.createContext(defaultContext);
    const index = defaultContexts.length;
    defaultContexts = [...defaultContexts, defaultContext];
    const Provider2 = (props) => {
      const { scope, children, ...context } = props;
  ...
  const createScope = () => {
    const scopeContexts = defaultContexts.map((defaultContext) => {
      return React48.createContext(defaultContext);
    });
    return function useScope(scope) {
      const contexts = scope?.[scopeName] || scopeContexts;
...
function composeContextScopes11(...scopes) {
  ...
  const createScope = () => {
    ...
    return function useComposedScopes(overrideScopes) {
      ...
      return React48.useMemo(() => ({ [`__scope${baseScope.scopeName}`]: nextScopes }), [nextScopes]);
    };
  };
  createScope.scopeName = baseScope.scopeName;
  return createScope;
...
var [createPasswordToggleFieldContext] = createContextScope11(PASSWORD_TOGGLE_FIELD_NAME);
...
var PasswordToggleField = ({
  ...
  const [inputIdState, setInputIdState] = React49.useState(defaultInputId);
  const inputId = inputIdState ?? defaultInputId;
  const syncInputId = React49.useCallback(
  ...
  const focusState = React49.useRef(INITIAL_FOCUS_STATE);
...
var PasswordToggleFieldInput = React49.forwardRef(
  ({
    __scopePasswordToggleField,
...
var PasswordToggleFieldToggle = React49.forwardRef(
  ({
    __scopePasswordToggleField,
    onClick,
    onPointerDown,
    ...
    const [internalAriaLabel, setInternalAriaLabel] = React49.useState(void 0);
...
var PasswordToggleFieldIcon = React49.forwardRef(
  ({
    __scopePasswordToggleField,
    // @ts-expect-error
    children,
    ...
    return (0, import_jsx_runtime49.jsx)(Primitive11.svg, { ...domProps, ref: forwardedRef, "aria-hidden": true, asChild: true, children: visible ? visibleIcon : hiddenIcon });
  }
);
...
function createContextScope12(scopeName, createContextScopeDeps = []) {
  ...
  function createContext32(rootComponentName, defaultContext) {
    ...
    const Provider2 = (props) => {
      ...
      return (0, import_jsx_runtime50.jsx)(Context.Provider, { value, children });
    };
    Provider2.displayName = rootComponentName + "Provider";
    function useContext22(consumerName, scope) {
      const Context = scope?.[scopeName]?.[index] || BaseContext;
...
function createSlot13(ownerName) {
  ...
  const Slot25 = React51.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
...
function createSlottable13(ownerName) {
  ...
  Slottable25.displayName = `${ownerName}.Slottable`;
  Slottable25.__radixId = SLOTTABLE_IDENTIFIER13;
  return Slottable25;
}
...
var Primitive12 = NODES12.reduce((primitive, node) => {
  const Slot25 = createSlot13(`Primitive.${node}`);
...
var [createPopoverContext, createPopoverScope] = createContextScope12(POPOVER_NAME, [
  createPopperScope
]);
...
var Popover = (props) => {
  ...
  return (0, import_jsx_runtime53.jsx)(Root22, { ...popperScope, children: (0, import_jsx_runtime53.jsx)(
    PopoverProvider,
    {
...
var PopoverAnchor = React53.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime53.jsx)(Anchor, { ...popperScope, ...anchorProps, ref: forwardedRef });
  }
);
...
var PopoverTrigger = React53.forwardRef(
  (props, forwardedRef) => {
    ...
    const trigger = (0, import_jsx_runtime53.jsx)(
      Primitive12.button,
      {
        type: "button",
    ...
    return context.hasCustomAnchor ? trigger : (0, import_jsx_runtime53.jsx)(Anchor, { asChild: true, ...popperScope, children: trigger });
  }
);
...
var PopoverPortal = (props) => {
  ...
  return (0, import_jsx_runtime53.jsx)(PortalProvider2, { scope: __scopePopover, forceMount, children: (0, import_jsx_runtime53.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime53.jsx)(Portal, { asChild: true, container, children }) }) });
};
...
var PopoverContent = React53.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime53.jsx)(Presence, { present: forceMount || context.open, children: context.modal ? (0, import_jsx_runtime53.jsx)(PopoverContentModal, { ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime53.jsx)(PopoverContentNonModal, { ...contentProps, ref: forwardedRef }) });
  }
);
PopoverContent.displayName = CONTENT_NAME8;
var Slot14 = createSlot13("PopoverContent.RemoveScroll");
var PopoverContentModal = React53.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime53.jsx)(Combination_default, { as: Slot14, allowPinchZoom: true, children: (0, import_jsx_runtime53.jsx)(
      PopoverContentImpl,
      {
        ...props,
        ref: composedRefs,
...
var PopoverArrow = React53.forwardRef(
  (props, forwardedRef) => {
    ...
    const popperScope = usePopperScope2(__scopePopover);
    return (0, import_jsx_runtime53.jsx)(Arrow, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
...
function createContextScope13(scopeName, createContextScopeDeps = []) {
  ...
  function createContext32(rootComponentName, defaultContext) {
    ...
    const Provider2 = (props) => {
      ...
      return (0, import_jsx_runtime54.jsx)(Context.Provider, { value, children });
    };
    Provider2.displayName = rootComponentName + "Provider";
    function useContext22(consumerName, scope) {
      const Context = scope?.[scopeName]?.[index] || BaseContext;
...
function createSlot14(ownerName) {
  ...
  const Slot25 = React55.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React55.Children.count(newElement) > 1) return React55.Children.only(null);
          return React55.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime55.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React55.isValidElement(newElement) ? React55.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlottable14(ownerName) {
  ...
  Slottable25.displayName = `${ownerName}.Slottable`;
  Slottable25.__radixId = SLOTTABLE_IDENTIFIER14;
  return Slottable25;
}
var Slottable15 = createSlottable14("Slottable");
function isSlottable14(child) {
  return React55.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER14;
}
...
var Primitive13 = NODES13.reduce((primitive, node) => {
  const Slot25 = createSlot14(`Primitive.${node}`);
...
var DEFAULT_MAX = 100;
var [createProgressContext, createProgressScope] = createContextScope13(PROGRESS_NAME);
...
var Progress = React57.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime57.jsx)(ProgressProvider, { scope: __scopeProgress, value, max, children: (0, import_jsx_runtime57.jsx)(
      Primitive13.div,
      {
        "aria-valuemax": max,
        "aria-valuemin": 0,
...
function createSlot15(ownerName) {
  ...
  const Slot25 = React59.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
...
function createSlottable15(ownerName) {
  ...
  Slottable25.displayName = `${ownerName}.Slottable`;
  Slottable25.__radixId = SLOTTABLE_IDENTIFIER15;
  return Slottable25;
}
...
var Primitive14 = NODES14.reduce((primitive, node) => {
  const Slot25 = createSlot15(`Primitive.${node}`);
...
var [createRadioContext, createRadioScope] = createContextScope14(RADIO_NAME);
...
var Radio = React61.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime61.jsxs)(RadioProvider, { scope: __scopeRadio, checked, disabled, children: [
...
var RadioIndicator = React61.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime61.jsx)(Presence, { present: forceMount || context.checked, children: (0, import_jsx_runtime61.jsx)(
      Primitive14.span,
      {
...
var [createRadioGroupContext, createRadioGroupScope] = createContextScope14(RADIO_GROUP_NAME3, [
  createRovingFocusGroupScope,
  createRadioScope
]);
...
var RadioGroupIndicator = React210.forwardRef(
  (props, forwardedRef) => {
    ...
    const radioScope = useRadioScope(__scopeRadioGroup);
    return (0, import_jsx_runtime62.jsx)(RadioIndicator, { ...radioScope, ...indicatorProps, ref: forwardedRef });
  }
);
...
function createSlot16(ownerName) {
  ...
  const Slot25 = React62.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime63.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React62.isValidElement(newElement) ? React62.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlottable16(ownerName) {
  ...
  Slottable25.displayName = `${ownerName}.Slottable`;
  Slottable25.__radixId = SLOTTABLE_IDENTIFIER16;
  return Slottable25;
}
var Slottable17 = createSlottable16("Slottable");
function isSlottable16(child) {
  return React62.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER16;
}
...
var Primitive15 = NODES15.reduce((primitive, node) => {
  const Slot25 = createSlot16(`Primitive.${node}`);
  const Node = React63.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot25 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
...
function createContextScope15(scopeName, createContextScopeDeps = []) {
  let defaultContexts = [];
  function createContext32(rootComponentName, defaultContext) {
    const BaseContext = React64.createContext(defaultContext);
    const index = defaultContexts.length;
    defaultContexts = [...defaultContexts, defaultContext];
    const Provider2 = (props) => {
      const { scope, children, ...context } = props;
      const Context = scope?.[scopeName]?.[index] || BaseContext;
      const value = React64.useMemo(() => context, Object.values(context));
      return (0, import_jsx_runtime65.jsx)(Context.Provider, { value, children });
    };
    Provider2.displayName = rootComponentName + "Provider";
    function useContext22(consumerName, scope) {
      const Context = scope?.[scopeName]?.[index] || BaseContext;
      const context = React64.useContext(Context);
      if (context) return context;
      if (defaultContext !== void 0) return defaultContext;
      throw new Error(`\`${consumerName}\` must be used within \`${rootComponentName}\``);
    }
  ...
  const createScope = () => {
    const scopeContexts = defaultContexts.map((defaultContext) => {
      return React64.createContext(defaultContext);
    });
    return function useScope(scope) {
      const contexts = scope?.[scopeName] || scopeContexts;
...
function composeContextScopes15(...scopes) {
  ...
  const createScope = () => {
    ...
    return function useComposedScopes(overrideScopes) {
      ...
      return React64.useMemo(() => ({ [`__scope${baseScope.scopeName}`]: nextScopes }), [nextScopes]);
    };
  };
  createScope.scopeName = baseScope.scopeName;
  return createScope;
...
function useStateMachine(initialState, machine) {
  return React65.useReducer((state, event) => {
    const nextState = machine[state][event];
    return nextState ?? state;
  }, initialState);
}
var SCROLL_AREA_NAME = "ScrollArea";
var [createScrollAreaContext, createScrollAreaScope] = createContextScope15(SCROLL_AREA_NAME);
    ...
    return (0, import_jsx_runtime66.jsxs)(import_jsx_runtime66.Fragment, { children: [
      ...
      (0, import_jsx_runtime66.jsx)(
        Primitive15.div,
        {
          ...
          children: (0, import_jsx_runtime66.jsx)("div", { ref: context.onContentChange, style: { minWidth: "100%", display: "table" }, children })
        }
      )
    ] });
  }
...
var ScrollAreaScrollbar = React211.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.type === "hover" ? (0, import_jsx_runtime66.jsx)(ScrollAreaScrollbarHover, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "scroll" ? (0, import_jsx_runtime66.jsx)(ScrollAreaScrollbarScroll, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "auto" ? (0, import_jsx_runtime66.jsx)(ScrollAreaScrollbarAuto, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "always" ? (0, import_jsx_runtime66.jsx)(ScrollAreaScrollbarVisible, { ...scrollbarProps, ref: forwardedRef }) : null;
  }
);
...
var ScrollAreaScrollbarHover = React211.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime66.jsx)(Presence, { present: forceMount || visible, children: (0, import_jsx_runtime66.jsx)(
...
var ScrollAreaScrollbarScroll = React211.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime66.jsx)(Presence, { present: forceMount || state !== "hidden", children: (0, import_jsx_runtime66.jsx)(
...
var ScrollAreaThumb = React211.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime66.jsx)(Presence, { present: forceMount || scrollbarContext.hasThumb, children: (0, import_jsx_runtime66.jsx)(ScrollAreaThumbImpl, { ref: forwardedRef, ...thumbProps }) });
  }
);
...
var ScrollAreaCorner = React211.forwardRef(
  (props, forwardedRef) => {
    ...
    return hasCorner ? (0, import_jsx_runtime66.jsx)(ScrollAreaCornerImpl, { ...props, ref: forwardedRef }) : null;
  }
);
...
var ScrollAreaCornerImpl = React211.forwardRef((props, forwardedRef) => {
  ...
  return hasSize ? (0, import_jsx_runtime66.jsx)(
    Primitive15.div,
    {
      ...cornerProps,
      ref: forwardedRef,
...
var Separator3 = React66.forwardRef((props, forwardedRef) => {
...
function createSlot17(ownerName) {
  ...
  const Slot25 = React68.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React68.Children.count(newElement) > 1) return React68.Children.only(null);
          return React68.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime69.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React68.isValidElement(newElement) ? React68.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlottable17(ownerName) {
  ...
  Slottable25.displayName = `${ownerName}.Slottable`;
  Slottable25.__radixId = SLOTTABLE_IDENTIFIER17;
  return Slottable25;
}
var Slottable18 = createSlottable17("Slottable");
function isSlottable17(child) {
  return React68.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER17;
}
...
var Primitive16 = NODES16.reduce((primitive, node) => {
  const Slot25 = createSlot17(`Primitive.${node}`);
  const Node = React69.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot25 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
...
var [createSliderContext, createSliderScope] = createContextScope16(SLIDER_NAME, [
  createCollectionScope5
]);
var [SliderProvider, useSliderContext] = createSliderContext(SLIDER_NAME);
var Slider = React70.forwardRef(
  (props, forwardedRef) => {
    const {
      name,
      min = 0,
    ...
    const thumbRefs = React70.useRef(/* @__PURE__ */ new Set());
    const valueIndexToChangeRef = React70.useRef(0);
    ...
    const valuesBeforeSlideStartRef = React70.useRef(values);
    ...
    return (0, import_jsx_runtime71.jsx)(
      SliderProvider,
      {
        ...
        orientation,
        form,
        children: (0, import_jsx_runtime71.jsx)(Collection5.Provider, { scope: props.__scopeSlider, children: (0, import_jsx_runtime71.jsx)(Collection5.Slot, { scope: props.__scopeSlider, children: (0, import_jsx_runtime71.jsx)(
          SliderOrientation,
          {
...
var SliderHorizontal = React70.forwardRef(
  (props, forwardedRef) => {
    const {
      min,
      max,
    ...
    const [slider, setSlider] = React70.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setSlider(node));
    const rectRef = React70.useRef(void 0);
    const direction = useDirection(dir);
    const isDirectionLTR = direction === "ltr";
...
var SliderVertical = React70.forwardRef(
  (props, forwardedRef) => {
    const {
      min,
      max,
...
var SliderImpl = React70.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSlider,
      onSlideStart,
...
var SliderTrack = React70.forwardRef(
  (props, forwardedRef) => {
...
var SliderRange = React70.forwardRef(
  (props, forwardedRef) => {
...
var SliderThumb = React70.forwardRef(
  (props, forwardedRef) => {
    const getItems = useCollection5(props.__scopeSlider);
    const [thumb, setThumb] = React70.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setThumb(node));
    const index = React70.useMemo(
      () => thumb ? getItems().findIndex((item) => item.ref.current === thumb) : -1,
      [getItems, thumb]
    );
    return (0, import_jsx_runtime71.jsx)(SliderThumbImpl, { ...props, ref: composedRefs, index });
  }
);
var SliderThumbImpl = React70.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime71.jsxs)(
      "span",
      {
        ...
        children: [
          (0, import_jsx_runtime71.jsx)(Collection5.ItemSlot, { scope: props.__scopeSlider, children: (0, import_jsx_runtime71.jsx)(
            Primitive16.span,
            {
              role: "slider",
          ...
          isFormControl2 && (0, import_jsx_runtime71.jsx)(
            SliderBubbleInput,
            {
...
var SliderBubbleInput = React70.forwardRef(
...
function createSlot18(ownerName) {
  ...
  const Slot25 = React72.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime73.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React72.isValidElement(newElement) ? React72.cloneElement(newElement, void 0, newChildren) : null });
    }
    return (0, import_jsx_runtime73.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children });
  });
  Slot25.displayName = `${ownerName}.Slot`;
  return Slot25;
}
...
function createSlottable18(ownerName) {
  const Slottable25 = ({ children }) => {
    return (0, import_jsx_runtime73.jsx)(import_jsx_runtime73.Fragment, { children });
  };
  Slottable25.displayName = `${ownerName}.Slottable`;
  Slottable25.__radixId = SLOTTABLE_IDENTIFIER18;
  return Slottable25;
}
var Slottable19 = createSlottable18("Slottable");
function isSlottable18(child) {
  return React72.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER18;
}
...
var Primitive17 = NODES17.reduce((primitive, node) => {
  const Slot25 = createSlot18(`Primitive.${node}`);
  const Node = React73.forwardRef((props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime74.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node };
}, {});
...
var [createSwitchContext, createSwitchScope] = createContextScope17(SWITCH_NAME);
...
var Switch = React74.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime75.jsxs)(SwitchProvider, { scope: __scopeSwitch, checked, disabled, children: [
      ...
      isFormControl2 && (0, import_jsx_runtime75.jsx)(
        SwitchBubbleInput,
        {
          control: button,
          bubbles: !hasConsumerStoppedPropagationRef.current,
...
var SwitchBubbleInput = React74.forwardRef(
  ({
    __scopeSwitch,
    control,
    checked,
...
function createContextScope18(scopeName, createContextScopeDeps = []) {
  let defaultContexts = [];
  function createContext32(rootComponentName, defaultContext) {
    const BaseContext = React75.createContext(defaultContext);
    const index = defaultContexts.length;
    defaultContexts = [...defaultContexts, defaultContext];
    const Provider2 = (props) => {
      const { scope, children, ...context } = props;
      const Context = scope?.[scopeName]?.[index] || BaseContext;
      const value = React75.useMemo(() => context, Object.values(context));
      return (0, import_jsx_runtime76.jsx)(Context.Provider, { value, children });
    };
    Provider2.displayName = rootComponentName + "Provider";
    function useContext22(consumerName, scope) {
      const Context = scope?.[scopeName]?.[index] || BaseContext;
      const context = React75.useContext(Context);
      if (context) return context;
      if (defaultContext !== void 0) return defaultContext;
      throw new Error(`\`${consumerName}\` must be used within \`${rootComponentName}\``);
    }
  ...
  const createScope = () => {
    const scopeContexts = defaultContexts.map((defaultContext) => {
      return React75.createContext(defaultContext);
    });
    return function useScope(scope) {
      const contexts = scope?.[scopeName] || scopeContexts;
...
function composeContextScopes18(...scopes) {
  ...
  const createScope = () => {
    ...
    return function useComposedScopes(overrideScopes) {
      ...
      return React75.useMemo(() => ({ [`__scope${baseScope.scopeName}`]: nextScopes }), [nextScopes]);
    };
  };
  createScope.scopeName = baseScope.scopeName;
  return createScope;
...
function createSlot19(ownerName) {
  ...
  const Slot25 = React76.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime77.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React76.isValidElement(newElement) ? React76.cloneElement(newElement, void 0, newChildren) : null });
    }
    return (0, import_jsx_runtime77.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children });
  });
  Slot25.displayName = `${ownerName}.Slot`;
  return Slot25;
}
...
function createSlottable19(ownerName) {
  const Slottable25 = ({ children }) => {
    return (0, import_jsx_runtime77.jsx)(import_jsx_runtime77.Fragment, { children });
  };
  Slottable25.displayName = `${ownerName}.Slottable`;
  Slottable25.__radixId = SLOTTABLE_IDENTIFIER19;
  return Slottable25;
}
var Slottable20 = createSlottable19("Slottable");
function isSlottable19(child) {
  return React76.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER19;
}
...
var Primitive18 = NODES18.reduce((primitive, node) => {
  const Slot25 = createSlot19(`Primitive.${node}`);
  const Node = React77.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot25 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
    }
    return (0, import_jsx_runtime78.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node };
}, {});
...
var TABS_NAME = "Tabs";
var [createTabsContext, createTabsScope] = createContextScope18(TABS_NAME, [
  createRovingFocusGroupScope
]);
...
var TabsList = React78.forwardRef(
  (props, forwardedRef) => {
...
var TabsTrigger = React78.forwardRef(
  (props, forwardedRef) => {
...
var TabsContent = React78.forwardRef(
  (props, forwardedRef) => {
    ...
    const contentId = makeContentId2(context.baseId, value);
    const isSelected = value === context.value;
    const isMountAnimationPreventedRef = React78.useRef(isSelected);
    React78.useEffect(() => {
      const rAF = requestAnimationFrame(() => isMountAnimationPreventedRef.current = false);
      return () => cancelAnimationFrame(rAF);
    }, []);
    return (0, import_jsx_runtime79.jsx)(Presence, { present: forceMount || isSelected, children: ({ present }) => (0, import_jsx_runtime79.jsx)(
      Primitive18.div,
      {
        "data-state": isSelected ? "active" : "inactive",
        "data-orientation": context.orientation,
...
function createContextScope19(scopeName, createContextScopeDeps = []) {
  ...
  function createContext32(rootComponentName, defaultContext) {
    ...
    const Provider2 = (props) => {
      ...
      return (0, import_jsx_runtime80.jsx)(Context.Provider, { value, children });
    };
    Provider2.displayName = rootComponentName + "Provider";
    function useContext22(consumerName, scope) {
      const Context = scope?.[scopeName]?.[index] || BaseContext;
...
function createSlot20(ownerName) {
  ...
  const Slot25 = React80.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime81.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React80.isValidElement(newElement) ? React80.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlottable20(ownerName) {
  ...
  Slottable25.displayName = `${ownerName}.Slottable`;
  Slottable25.__radixId = SLOTTABLE_IDENTIFIER20;
  return Slottable25;
}
var Slottable21 = createSlottable20("Slottable");
function isSlottable20(child) {
  return React80.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER20;
}
...
var Primitive19 = NODES19.reduce((primitive, node) => {
  const Slot25 = createSlot20(`Primitive.${node}`);
  const Node = React81.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot25 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
...
function dispatchDiscreteCustomEvent2(target, event) {
  if (target) ReactDOM20.flushSync(() => target.dispatchEvent(event));
}
...
var [createToastContext, createToastScope] = createContextScope19("Toast", [createCollectionScope6]);
...
var ToastProvider = (props) => {
  ...
  const [toastCount, setToastCount] = React82.useState(0);
  const isFocusedToastEscapeKeyDownRef = React82.useRef(false);
  const isClosePausedRef = React82.useRef(false);
  if (!label.trim()) {
    console.error(
      `Invalid prop \`label\` supplied to \`${PROVIDER_NAME}\`. Expected non-empty \`string\`.`
    );
  }
  return (0, import_jsx_runtime83.jsx)(Collection6.Provider, { scope: __scopeToast, children: (0, import_jsx_runtime83.jsx)(
    ToastProviderProvider,
    {
      ...
      viewport,
      onViewportChange: setViewport,
      onToastAdd: React82.useCallback(() => setToastCount((prevCount) => prevCount + 1), []),
      onToastRemove: React82.useCallback(() => setToastCount((prevCount) => prevCount - 1), []),
...
var ToastViewport = React82.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
    ...
    const headFocusProxyRef = React82.useRef(null);
    const tailFocusProxyRef = React82.useRef(null);
    ...
    const getSortedTabbableCandidates = React82.useCallback(
      ({ tabbingDirection }) => {
    ...
    return (0, import_jsx_runtime83.jsxs)(
      Branch,
      {
        ...
        children: [
          hasToasts && (0, import_jsx_runtime83.jsx)(
            FocusProxy,
            {
          ...
          (0, import_jsx_runtime83.jsx)(Collection6.Slot, { scope: __scopeToast, children: (0, import_jsx_runtime83.jsx)(Primitive19.ol, { tabIndex: -1, ...viewportProps, ref: composedRefs }) }),
          hasToasts && (0, import_jsx_runtime83.jsx)(
            FocusProxy,
            {
...
var FocusProxy = React82.forwardRef(
  (props, forwardedRef) => {
...
var Toast = React82.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime83.jsx)(Presence, { present: forceMount || open, children: (0, import_jsx_runtime83.jsx)(
      ToastImpl,
      {
        open,
        ...toastProps,
...
var ToastImpl = React82.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
      type = "foreground",
    ...
    const [node, setNode] = React82.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node2) => setNode(node2));
    const pointerStartRef = React82.useRef(null);
    const swipeDeltaRef = React82.useRef(null);
    const duration = durationProp || context.duration;
    const closeTimerStartTimeRef = React82.useRef(0);
    const closeTimerRemainingTimeRef = React82.useRef(duration);
    const closeTimerRef = React82.useRef(0);
    ...
    const startTimer = React82.useCallback(
      (duration2) => {
    ...
    const announceTextContent = React82.useMemo(() => {
      return node ? getAnnounceTextContent(node) : null;
    }, [node]);
    if (!context.viewport) return null;
    return (0, import_jsx_runtime83.jsxs)(import_jsx_runtime83.Fragment, { children: [
      announceTextContent && (0, import_jsx_runtime83.jsx)(
        ToastAnnounce,
        {
          __scopeToast,
          role: "status",
      ...
      (0, import_jsx_runtime83.jsx)(ToastInteractiveProvider, { scope: __scopeToast, onClose: handleClose, children: ReactDOM21.createPortal(
        (0, import_jsx_runtime83.jsx)(Collection6.ItemSlot, { scope: __scopeToast, children: (0, import_jsx_runtime83.jsx)(
          Root,
          {
            asChild: true,
...
var ToastAnnounce = (props) => {
  ...
  const context = useToastProviderContext(TOAST_NAME, __scopeToast);
  const [renderAnnounceText, setRenderAnnounceText] = React82.useState(false);
  const [isAnnounced, setIsAnnounced] = React82.useState(false);
  useNextFrame(() => setRenderAnnounceText(true));
  React82.useEffect(() => {
    const timer = window.setTimeout(() => setIsAnnounced(true), 1e3);
    return () => window.clearTimeout(timer);
  }, []);
  return isAnnounced ? null : (0, import_jsx_runtime83.jsx)(Portal, { asChild: true, children: (0, import_jsx_runtime83.jsx)(VisuallyHidden, { ...announceProps, children: renderAnnounceText && (0, import_jsx_runtime83.jsxs)(import_jsx_runtime83.Fragment, { children: [
    context.label,
    " ",
    children
  ] }) }) });
...
var ToastTitle = React82.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToast, ...titleProps } = props;
    return (0, import_jsx_runtime83.jsx)(Primitive19.div, { ...titleProps, ref: forwardedRef });
  }
);
ToastTitle.displayName = TITLE_NAME2;
var DESCRIPTION_NAME2 = "ToastDescription";
var ToastDescription = React82.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToast, ...descriptionProps } = props;
    return (0, import_jsx_runtime83.jsx)(Primitive19.div, { ...descriptionProps, ref: forwardedRef });
  }
);
ToastDescription.displayName = DESCRIPTION_NAME2;
var ACTION_NAME2 = "ToastAction";
var ToastAction = React82.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime83.jsx)(ToastAnnounceExclude, { altText, asChild: true, children: (0, import_jsx_runtime83.jsx)(ToastClose, { ...actionProps, ref: forwardedRef }) });
  }
);
ToastAction.displayName = ACTION_NAME2;
var CLOSE_NAME2 = "ToastClose";
var ToastClose = React82.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToast, ...closeProps } = props;
    const interactiveContext = useToastInteractiveContext(CLOSE_NAME2, __scopeToast);
    return (0, import_jsx_runtime83.jsx)(ToastAnnounceExclude, { asChild: true, children: (0, import_jsx_runtime83.jsx)(
      Primitive19.button,
      {
        type: "button",
        ...closeProps,
...
var ToastAnnounceExclude = React82.forwardRef((props, forwardedRef) => {
...
function createSlot21(ownerName) {
  ...
  const Slot25 = React83.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React83.Children.count(newElement) > 1) return React83.Children.only(null);
          return React83.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime84.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React83.isValidElement(newElement) ? React83.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlotClone21(ownerName) {
  const SlotClone = React83.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React83.isValidElement(children)) {
      const childrenRef = getElementRef21(children);
      const props2 = mergeProps21(slotProps, children.props);
      if (children.type !== React83.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return React83.cloneElement(children, props2);
    }
    return React83.Children.count(children) > 1 ? React83.Children.only(null) : null;
  });
  SlotClone.displayName = `${ownerName}.SlotClone`;
  return SlotClone;
}
...
function createSlottable21(ownerName) {
  ...
  Slottable25.displayName = `${ownerName}.Slottable`;
  Slottable25.__radixId = SLOTTABLE_IDENTIFIER21;
  return Slottable25;
}
var Slottable22 = createSlottable21("Slottable");
function isSlottable21(child) {
  return React83.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER21;
}
...
var Primitive20 = NODES20.reduce((primitive, node) => {
  const Slot25 = createSlot21(`Primitive.${node}`);
  const Node = React84.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot25 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
...
var NAME6 = "Toggle";
var Toggle = React85.forwardRef((props, forwardedRef) => {
...
function createContextScope20(scopeName, createContextScopeDeps = []) {
  let defaultContexts = [];
  function createContext32(rootComponentName, defaultContext) {
    const BaseContext = React86.createContext(defaultContext);
    const index = defaultContexts.length;
    defaultContexts = [...defaultContexts, defaultContext];
    const Provider2 = (props) => {
      const { scope, children, ...context } = props;
      const Context = scope?.[scopeName]?.[index] || BaseContext;
      const value = React86.useMemo(() => context, Object.values(context));
      return (0, import_jsx_runtime87.jsx)(Context.Provider, { value, children });
    };
    Provider2.displayName = rootComponentName + "Provider";
    function useContext22(consumerName, scope) {
      const Context = scope?.[scopeName]?.[index] || BaseContext;
      const context = React86.useContext(Context);
      if (context) return context;
      if (defaultContext !== void 0) return defaultContext;
      throw new Error(`\`${consumerName}\` must be used within \`${rootComponentName}\``);
    }
  ...
  const createScope = () => {
    const scopeContexts = defaultContexts.map((defaultContext) => {
      return React86.createContext(defaultContext);
    });
    return function useScope(scope) {
      const contexts = scope?.[scopeName] || scopeContexts;
...
function composeContextScopes20(...scopes) {
  ...
  const createScope = () => {
    ...
    return function useComposedScopes(overrideScopes) {
      ...
      return React86.useMemo(() => ({ [`__scope${baseScope.scopeName}`]: nextScopes }), [nextScopes]);
    };
  };
  createScope.scopeName = baseScope.scopeName;
  return createScope;
...
function createSlot22(ownerName) {
  ...
  const Slot25 = React87.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React87.Children.count(newElement) > 1) return React87.Children.only(null);
          return React87.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime88.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React87.isValidElement(newElement) ? React87.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlotClone22(ownerName) {
  const SlotClone = React87.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React87.isValidElement(children)) {
      const childrenRef = getElementRef22(children);
      const props2 = mergeProps22(slotProps, children.props);
      if (children.type !== React87.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return React87.cloneElement(children, props2);
    }
    return React87.Children.count(children) > 1 ? React87.Children.only(null) : null;
  });
  SlotClone.displayName = `${ownerName}.SlotClone`;
  return SlotClone;
}
...
function createSlottable22(ownerName) {
  ...
  Slottable25.displayName = `${ownerName}.Slottable`;
  Slottable25.__radixId = SLOTTABLE_IDENTIFIER22;
  return Slottable25;
}
var Slottable23 = createSlottable22("Slottable");
function isSlottable22(child) {
  return React87.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER22;
}
...
var Primitive21 = NODES21.reduce((primitive, node) => {
  const Slot25 = createSlot22(`Primitive.${node}`);
  const Node = React88.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot25 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
...
var [createToggleGroupContext, createToggleGroupScope] = createContextScope20(TOGGLE_GROUP_NAME, [
  createRovingFocusGroupScope
]);
...
var ToggleGroup = import_react2.default.forwardRef((props, forwardedRef) => {
  ...
  if (type === "single") {
    ...
    return (0, import_jsx_runtime90.jsx)(ToggleGroupImplSingle, { ...singleProps, ref: forwardedRef });
  }
  if (type === "multiple") {
    const multipleProps = toggleGroupProps;
    return (0, import_jsx_runtime90.jsx)(ToggleGroupImplMultiple, { ...multipleProps, ref: forwardedRef });
  }
...
var ToggleGroupImplSingle = import_react2.default.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime90.jsx)(
    ToggleGroupValueProvider,
    {
      ...
      children: (0, import_jsx_runtime90.jsx)(ToggleGroupImpl, { ...toggleGroupSingleProps, ref: forwardedRef })
    }
  );
});
var ToggleGroupImplMultiple = import_react2.default.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime90.jsx)(
    ToggleGroupValueProvider,
    {
      ...
      children: (0, import_jsx_runtime90.jsx)(ToggleGroupImpl, { ...toggleGroupMultipleProps, ref: forwardedRef })
    }
  );
});
ToggleGroup.displayName = TOGGLE_GROUP_NAME;
...
var ToggleGroupImpl = import_react2.default.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime90.jsx)(ToggleGroupContext, { scope: __scopeToggleGroup, rovingFocus, disabled, children: rovingFocus ? (0, import_jsx_runtime90.jsx)(
      Root3,
      {
        asChild: true,
        ...rovingFocusGroupScope,
        ...
        dir: direction,
        loop,
        children: (0, import_jsx_runtime90.jsx)(Primitive21.div, { ...commonProps, ref: forwardedRef })
      }
    ) : (0, import_jsx_runtime90.jsx)(Primitive21.div, { ...commonProps, ref: forwardedRef }) });
  }
);
...
var ToggleGroupItem = import_react2.default.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.rovingFocus ? (0, import_jsx_runtime90.jsx)(
      Item,
      {
        asChild: true,
        ...rovingFocusGroupScope,
        ...
        active: pressed,
        ref,
        children: (0, import_jsx_runtime90.jsx)(ToggleGroupItemImpl, { ...commonProps, ref: forwardedRef })
      }
    ) : (0, import_jsx_runtime90.jsx)(ToggleGroupItemImpl, { ...commonProps, ref: forwardedRef });
  }
);
...
function createContextScope21(scopeName, createContextScopeDeps = []) {
  let defaultContexts = [];
  function createContext32(rootComponentName, defaultContext) {
    const BaseContext = React90.createContext(defaultContext);
    const index = defaultContexts.length;
    defaultContexts = [...defaultContexts, defaultContext];
    const Provider2 = (props) => {
      const { scope, children, ...context } = props;
      const Context = scope?.[scopeName]?.[index] || BaseContext;
      const value = React90.useMemo(() => context, Object.values(context));
      return (0, import_jsx_runtime91.jsx)(Context.Provider, { value, children });
    };
    Provider2.displayName = rootComponentName + "Provider";
    function useContext22(consumerName, scope) {
      const Context = scope?.[scopeName]?.[index] || BaseContext;
      const context = React90.useContext(Context);
      if (context) return context;
      if (defaultContext !== void 0) return defaultContext;
      throw new Error(`\`${consumerName}\` must be used within \`${rootComponentName}\``);
    }
  ...
  const createScope = () => {
    const scopeContexts = defaultContexts.map((defaultContext) => {
      return React90.createContext(defaultContext);
    });
    return function useScope(scope) {
      const contexts = scope?.[scopeName] || scopeContexts;
...
function composeContextScopes21(...scopes) {
  ...
  const createScope = () => {
    ...
    return function useComposedScopes(overrideScopes) {
      ...
      return React90.useMemo(() => ({ [`__scope${baseScope.scopeName}`]: nextScopes }), [nextScopes]);
    };
  };
  createScope.scopeName = baseScope.scopeName;
  return createScope;
...
function createSlot23(ownerName) {
  ...
  const Slot25 = React91.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React91.Children.count(newElement) > 1) return React91.Children.only(null);
          return React91.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime92.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React91.isValidElement(newElement) ? React91.cloneElement(newElement, void 0, newChildren) : null });
    }
    return (0, import_jsx_runtime92.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children });
  });
  Slot25.displayName = `${ownerName}.Slot`;
  return Slot25;
}
...
function createSlotClone23(ownerName) {
  const SlotClone = React91.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React91.isValidElement(children)) {
      ...
      if (children.type !== React91.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return React91.cloneElement(children, props2);
    }
...
function createSlottable23(ownerName) {
  const Slottable25 = ({ children }) => {
    return (0, import_jsx_runtime92.jsx)(import_jsx_runtime92.Fragment, { children });
  };
  Slottable25.displayName = `${ownerName}.Slottable`;
  Slottable25.__radixId = SLOTTABLE_IDENTIFIER23;
  return Slottable25;
}
var Slottable24 = createSlottable23("Slottable");
function isSlottable23(child) {
  return React91.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER23;
}
...
var Primitive22 = NODES22.reduce((primitive, node) => {
  const Slot25 = createSlot23(`Primitive.${node}`);
  const Node = React92.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot25 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
    }
    return (0, import_jsx_runtime93.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node };
}, {});
...
var Separator4 = React93.forwardRef((props, forwardedRef) => {
...
var [createToolbarContext, createToolbarScope] = createContextScope21(TOOLBAR_NAME, [
  createRovingFocusGroupScope,
...
var Toolbar = React94.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, orientation = "horizontal", dir, loop = true, ...toolbarProps } = props;
    const rovingFocusGroupScope = useRovingFocusGroupScope6(__scopeToolbar);
    const direction = useDirection(dir);
    return (0, import_jsx_runtime95.jsx)(ToolbarProvider, { scope: __scopeToolbar, orientation, dir: direction, children: (0, import_jsx_runtime95.jsx)(
      Root3,
      {
        asChild: true,
        ...rovingFocusGroupScope,
...
var ToolbarSeparator = React94.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarButton = React94.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, ...buttonProps } = props;
    const rovingFocusGroupScope = useRovingFocusGroupScope6(__scopeToolbar);
    return (0, import_jsx_runtime95.jsx)(Item, { asChild: true, ...rovingFocusGroupScope, focusable: !props.disabled, children: (0, import_jsx_runtime95.jsx)(Primitive22.button, { type: "button", ...buttonProps, ref: forwardedRef }) });
  }
);
ToolbarButton.displayName = BUTTON_NAME;
var LINK_NAME2 = "ToolbarLink";
var ToolbarLink = React94.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, ...linkProps } = props;
    const rovingFocusGroupScope = useRovingFocusGroupScope6(__scopeToolbar);
    return (0, import_jsx_runtime95.jsx)(Item, { asChild: true, ...rovingFocusGroupScope, focusable: true, children: (0, import_jsx_runtime95.jsx)(
      Primitive22.a,
      {
        ...linkProps,
        ref: forwardedRef,
...
var ToolbarToggleGroup = React94.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarToggleItem = React94.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, ...toggleItemProps } = props;
    const toggleGroupScope = useToggleGroupScope(__scopeToolbar);
    const scope = { __scopeToolbar: props.__scopeToolbar };
    return (0, import_jsx_runtime95.jsx)(ToolbarButton, { asChild: true, ...scope, children: (0, import_jsx_runtime95.jsx)(Item24, { ...toggleGroupScope, ...toggleItemProps, ref: forwardedRef }) });
  }
);
...
export {
  dist_exports9 as AccessibleIcon,
  dist_exports11 as Accordion,
  dist_exports12 as AlertDialog,
  dist_exports13 as AspectRatio,
  dist_exports15 as Avatar,
  dist_exports as Checkbox,
  dist_exports10 as Collapsible,
