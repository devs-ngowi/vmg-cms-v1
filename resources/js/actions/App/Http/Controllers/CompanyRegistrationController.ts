...
/**
* @see \App\Http\Controllers\CompanyRegistrationController::create
...
const CompanyRegistrationController = { create, store }

export default CompanyRegistrationController